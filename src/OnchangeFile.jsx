...
function ChangeHandler() {
    ...
    return (
        <div>
            ...
            <br />
            <label >
                <input type="radio" value='pick up' checked = {shippingMethod === 'pick up'} onChange={handleShipment} />
                pick up
            </label><br />
            <br />
            <label >
                <input type="radio" value='delivery' checked = {shippingMethod === 'delivery'} onChange={handleShipment} />
                delivery
            </label><br />
            <p>Shippment Method: {shippingMethod}</p>
        </div>
    )
}
