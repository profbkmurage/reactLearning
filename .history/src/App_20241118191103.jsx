...
function App() {
  ...
  return (
    ...
    <>
      ...
      {cars.length > 0 && <ReusableList items={cars} cartegory='Cars ' />} {/*this will render the car list conditionally such that when the list is empty then it will not appear on the fronten*/}
      <hr />
